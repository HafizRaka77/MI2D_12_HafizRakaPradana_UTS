...
<script>
    ...
    // ------------------ destination 1 ---------------------------
    var m1 = L.marker([-7.878920, 112.520115]).addTo(mymap);
    m1.bindPopup("<h1>Museum Angkut</h1> <img src = '/img/map/mp1.jpg' />")
    ...
    // ------------------ destination 3 ---------------------------
    var m3 = L.marker([-7.888214, 112.529187]).addTo(mymap);
    m3.bindPopup("<h1>Jatimpark 2</h1> <img src = '/img/map/mp3.jpg' />")

    // ------------------ destination 4 ---------------------------
    var m4 = L.marker([-7.897562, 112.554618]).addTo(mymap);
    ...
    // ------------------ destination 6 ---------------------------
    var m6 = L.marker([-7.896443, 112.534499]).addTo(mymap);
